package com.leejean.userDrawMr;

import java.io.IOException;
import java.text.SimpleDateFormat;

import com.leejean.userDraw4Hbase.UserDrawPutInHbaseMap;
import com.leejean.userDraw4Hbase.UserDrawPutInHbaseReduce;
import com.leejean.utils.Config;
import com.leejean.utils.TextArrayWritable;
...
public class UserDrawMapReduce {
	...
	public static void main(String[] args) throws Exception {
		...
		FileInputFormat.addInputPath(job1, new Path("E:\\tmp\\userDrawData\\userdata.txt"));// 输入路径
		FileOutputFormat.setOutputPath(job1, new Path("E:\\tmp\\userDrawData\\out1"));// 输出路径
		...
		System.out.println("job1执行成功！！！");
			if (state1) {
				...
				FileInputFormat.addInputPath(job2, new Path("E:\\tmp\\userDrawData\\out1"));// 输入路径
				FileOutputFormat.setOutputPath(job2, new Path("E:\\tmp\\userDrawData\\out2"));// 输出路径
